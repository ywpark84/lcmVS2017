...
Please refer to the website pr any other external resources (i.e. MRShub, https://mrshub.org/) for any questions related to the source code
...
Once the libraries are installed, copy the DLLs into the same directories that the compiled binaries are located
